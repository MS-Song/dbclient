...
webix.protoUI({
	...
	defaults : {
		...
		extraKeys : {
				...
				"Alt-1" : function(cm) {javaModel();},
				"Alt-2" : function(cm) {javaHibernateModel();},
				"Alt-3" : function(cm) {javaModelSet();},
				"Alt-4" : function(cm) {javaModelGet();},
				"Alt-5" : function(cm) {mybatisSelect();},
				"Alt-6" : function(cm) {mybatisInsert();},
				"Alt-7" : function(cm) {mybatisUpdate();},
				"Alt-8" : function(cm) {mybatisDelete();},
				"Alt-9" : function(cm) {mybatisResultMap();}
			}
		},
		...
		_render_cm_editor : function() {
			var deps = [ "lib/codemirror.css", "doc/docs.css",
