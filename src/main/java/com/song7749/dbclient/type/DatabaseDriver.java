...
public enum DatabaseDriver {
	...
	ORACLE(
			...
			// index list
			"SELECT a.OWNER, a.INDEX_NAME, a.INDEX_TYPE, a.UNIQUENESS, a.NUM_ROWS CARDINALITY , b.COLUMN_NAME, b.COLUMN_POSITION,b.DESCEND FROM ALL_INDEXES a, ALL_IND_COLUMNS b WHERE a.index_name = b.index_name and a.OWNER=b.OWNER AND  a.OWNER=upper('{schemaOwner}') AND a.table_name='{name}'",
			// explain
