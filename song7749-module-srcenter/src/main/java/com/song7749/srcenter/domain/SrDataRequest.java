...
public class SrDataRequest extends Entities {
     ...
     */
    public SrDataRequest(@NotBlank @Length(max = 200) String subject, @NotBlank @Length(max = 12000) String runSql, @NotNull Integer downloadLimit, @NotNull Integer downloadCount, DownloadLimitType downloadLimitType, Date downloadStartDate, Date downloadEndDate, @NotNull YN enableYN, Database database, @NotNull Member resistMember, List<Member> srDataAllowMembers) {
